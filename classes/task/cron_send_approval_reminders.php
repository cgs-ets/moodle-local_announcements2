...
class cron_send_approval_reminders extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('cron_send_approval_reminders', 'local_announcements2');
    }
    ...
    protected function send_reminder($activity, $username, $email) {
        ...
        $messageHtml = $OUTPUT->render_from_template('local_announcements2/email_approval_reminder_html', $activity);
